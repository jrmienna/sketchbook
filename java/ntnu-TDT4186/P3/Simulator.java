...
public class Simulator implements Constants
{
	...
	public Simulator(Queue memoryQueue, Queue cpuQueue, Queue ioQueue, long memorySize,
		...
		cpu = new CPU(maxCpuTime, cpuQueue, gui, statistics);
		io = new IO(avgIoTime, ioQueue, gui, statistics);
    }
	...
	public void simulate() {
		// TODO: You may want to expend this method somewhat.
	...
	private void flushMemoryQueue() {
		...
		while(p != null) {
			...
			eventQueue.insertEvent(cpu.queueProcess(p, clock));
	...
	private void endProcess() {
		Process endingProcess = cpu.getProcess();
	...
	private void processIoRequest() {
		...
		// Switch in a new process in CPU
		eventQueue.insertEvent(cpu.activeProcessLeft(clock));
	}
	...
	private void endIoOperation() {
		...
		eventQueue.insertEvent(cpu.queueProcess(endingProcess, clock));
		// Start new IO operation
