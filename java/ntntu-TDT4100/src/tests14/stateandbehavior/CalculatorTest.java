package tests14.stateandbehavior;

import no.hal.jex.runtime.JExercise;
import no.hal.jex.standalone.JexStandalone;
import junit.framework.TestCase;
import exercises14.exercise02.calculator.Calculator;
...
public class CalculatorTest extends TestCase {
	...
	public void testSetFirstOperand() {
		...
		assertEquals(calculator.leftOperand, 0.0);
		calculator.setFirstOperand(-5.0);
		assertEquals(calculator.leftOperand, -5.0);
		calculator.setFirstOperand(5.0);
		assertEquals(calculator.leftOperand, 5.0);
	}
	...
	public void testSetSecondOperand() {
		...
		assertEquals(calculator.rightOperand, 0.0);
		calculator.setSecondOperand(-5.0);
		assertEquals(calculator.rightOperand, -5.0);
		calculator.setSecondOperand(5.0);
		assertEquals(calculator.rightOperand, 5.0);
	}
