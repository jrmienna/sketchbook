...
public class FruitsAndStuff extends Application {
    ...
    private Node createCenter() {
        ...
        ListView<String> vegetables = new ListView<String>(FXCollections.observableArrayList("Asparagus", "Beans", "Broccoli", "Cabbage"
    ...
    private Node createTop() {
        ...
        ChoiceBox<String> fruits = new ChoiceBox<String>(FXCollections.observableArrayList("Apple", "Apricot", "Banana"
    ...
    private Node createBottom() {
        ...
        vegFruitBut.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                // Uses the root to the scene graph, and retrieves the references through the object id. Lookup is given CSS-text.
