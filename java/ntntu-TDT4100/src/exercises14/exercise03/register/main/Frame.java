...
import exercises14.exercise03.register.registration.PersonData;
import exercises14.exercise03.register.registration.PersonValidation;
...
public class Frame extends JFrame implements ActionListener {
	...
	public Frame() {
		...
		validation = new PersonValidation();
	...
	public void actionPerformed(ActionEvent e) { 	
		if (e.getSource() == finishButton) {
			...
			else if(!validation.isValidEmail(email, name, false)) {
				JOptionPane.showMessageDialog(null, "Email not valid");
			}
			else if(!validation.isValidGender(gender, false)) {
				JOptionPane.showMessageDialog(null, "Gender not valid");
			}
			else if(!validation.isValidSSN(sSN, date, gender, false)) {
