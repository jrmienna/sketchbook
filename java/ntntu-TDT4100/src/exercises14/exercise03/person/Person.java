...
public class Person {
	...
	public void setName(String name, boolean throwsException) {
		if (isValidName(name, throwsException)) {
			this.name = name;
		}
	}
	...
	public void setEmail(String email) {
		isValidEmail(email, this.name, true);
		this.email = email;
	}

	public void setEmail(String email, boolean throwsException) {
		if (isValidEmail(email, this.name, throwsException)
				&& this.name != null) {
			this.email = email;
		}
	}
	...
	public void setGender(char gender) {
		isValidGender(gender, true);
		this.gender = gender;
	}

	public void setGender(char gender, boolean throwsException) {
		if (isValidGender(gender, throwsException)) {
			this.gender = gender;
		}
	}

	public boolean isValidSSN(String sSN, Date birthday, char gender, boolean throwsException) {
		...
		if (!birthday.equals(testBirthday)) {
			if (throwsException) {
				throw new IllegalArgumentException(
						"Social security number does not match with given birthday");
			}
			return false;
		}
	...
	public void setSSN(String sSN) {
		isValidSSN(sSN, this.birthday, this.gender, true);
		this.sSN = sSN;
	}

	public void setSSN(String sSN, boolean throwsException) {
		if (isValidSSN(sSN, this.birthday, this.gender, throwsException)) {
			this.sSN = sSN;
		}
	}
