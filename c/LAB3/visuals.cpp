...
void RenderScene2()
{
    ...
    Projection = glm::perspective(45.0f, 1.0f / 3.0f, 0.5f, 100.0f);
...
void RenderScene3()
{
    // Projection matrix. Orthogonal parallell viewing volume:
    // left, right, bottom, top, zNear, zFar
    Projection = glm::ortho( -0.8f,  0.8f,   1.0f,   -1.2f,   0.0f,   500.0f     );
...
void RenderScene5()
{
    ...
    // Draw the triangle !
    glDrawArrays(GL_TRIANGLES, 0, 3); // Index, 0,1,2 (total of 3) -> 1 triangle
    glDrawArrays(GL_TRIANGLES, 3, 5); // Index, 3,4,5 (total of 3) -> 1 triangle
